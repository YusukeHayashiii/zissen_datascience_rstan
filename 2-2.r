...
suuretu <- 0:1000
suuretu
quantile(suuretu, probs = c(0.5)) # median(suuretu)でも可能
quantile(suuretu, probs = c(0.25))
quantile(suuretu, probs = c(0.75))
quantile(suuretu, probs = c(0.025, 0.975)) # 信用区間などで使う
